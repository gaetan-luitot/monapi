<template>
  <div class="add-mean">
    ...
    <form id="add-mean-form" @submit.prevent="CheckForm">
      ...
      <ul>
        <li>
          <div class="standard_input">
            <input id="input-mean-name" class="form-control" type="text" name="mean-name"
            v-model="name" placeholder="Name" autocomplete="off">
          </div>
        </li>
      </ul>
