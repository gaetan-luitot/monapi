...
export default {
    ...
    methods: {
        ...
        autocomplete(inp, arr, event) {
                ...
                for (i = 0; i < arr.length; i += 1) {
                    ...
                    if (arr[i].substr(0, val.length).toUpperCase() === val.toUpperCase()) {
                        ...
                        b.addEventListener('click', (e) => {
                            ...
                            // this.operator = e.target.lastChild.value;
            ...
            inp.addEventListener('operatorAdded', () => {
                if (!arr.find((operator) => operator === inp.value)) {
                    arr.push(inp.value);
                }
            });
    ...
    async mounted() {
        ...
        if (this.categories.length || input) {
            this.autocomplete(
                input, this.categories, this.afterUpdateEvent, this.operatorAddedEvent,
            );
